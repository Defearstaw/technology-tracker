...
function Home() {
  ...
  <h2>🌐 Интеграция с GitHub API</h2>
  <p>Ищите популярные технологии прямо из GitHub и добавляйте их в свой трекер</p>
  <div className="api-features">
    <div className="api-feature">
      <div className="feature-icon">🔍</div>
      <h3>Поиск технологий</h3>
      <p>Ищите репозитории по названию, описанию или языку программирования</p>
    </div>
    <div className="api-feature">
      <div className="feature-icon">⭐</div>
      <h3>Статистика популярности</h3>
      <p>Смотрите количество звёзд, форков и активность проектов</p>
    </div>
    <div className="api-feature">
      <div className="feature-icon">📊</div>
      <h3>Автоматическая классификация</h3>
      <p>Система автоматически определяет категорию технологии</p>
    </div>
  </div>
  <Link to="/api-search" className="btn-primary btn-large">
    🚀 Начать поиск на GitHub
  </Link>
</div>
    </div>
  );
